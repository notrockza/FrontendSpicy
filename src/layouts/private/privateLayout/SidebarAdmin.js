    ...
    <ul className="nav">
      ...
      <li className="nav-item">
        ...
        <div className="collapse" id="auth">
          <ul className="nav flex-column sub-menu">
            <li className="nav-item"> <a className="nav-link" href="/admin/user">Table User </a></li>
          </ul>
        </div>
      </li>
      <li className="nav-item">
        ...
        <div className="collapse" id="ui-basic">
          <ul className="nav flex-column sub-menu">
            <li className="nav-item"> <a className="nav-link" href="/admin/product">Table Product</a></li>
          </ul>
        </div>
      </li>
      <li className="nav-item">
        ...
        <div className="collapse" id="form-elements">
          <ul className="nav flex-column sub-menu">
            <li className="nav-item"><a className="nav-link" href="/admin/order">Order</a></li>
          </ul>
        </div>
      </li>
      ...
      <li className="nav-item">
        ...
        <div className="collapse" id="tables">
          <ul className="nav flex-column sub-menu">
            <li className="nav-item"> <a className="nav-link" href="/admin">Transport</a></li>
          </ul>
        </div>
      </li>
      {/* <li className="nav-item">
